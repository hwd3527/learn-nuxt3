...
export default {
  ...
  head: {
    ...
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/learn-nuxt3/favicon.ico' },
    ],
  },
  ...
  env: {
    baseURL:
      process.env.NODE_ENV === 'production'
        ? 'https://my-json-server.typicode.com/hwd3527/nuxt-shopping-api'
        : 'http://localhost:3000',
  },
  generate: {
    async routes() {
      const res = await axios.get(
        `https://my-json-server.typicode.com/hwd3527/nuxt-shopping-api/products`,
      );
